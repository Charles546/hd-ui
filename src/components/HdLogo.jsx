// Inline SVG derived from honeydipper/logo/logo.svg
// The gradient is replaced with currentColor so the logo adapts to any context.
export default function HdLogo({ size = 32, color = '#f6c90e', style = {} }) {
  return (
    <svg
